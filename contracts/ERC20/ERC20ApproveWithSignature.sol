...
import "./IERC20.sol";
import "../MetaTransaction/BasicMetaTransaction.sol";
import "./SafeMath.sol";

contract ERC20 is IERC20, BasicMetaTransaction {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(msgSender(), spender, _allowances[msgSender()][spender].sub(subtractedValue, "ERC20: decreased allowance below zero"));
        return true;
    }
